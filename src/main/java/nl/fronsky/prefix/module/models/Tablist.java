...
/**
 * Manages player tablist display, including team-based prefix and name color rendering.
 * <p>
 * Uses scoreboard teams with weight-based sorting to control player order in the tab list.
 */
